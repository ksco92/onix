...
def test_a_zoneinfo_datetime_round_trips_as_a_fixed_offset_timezone() -> None:
    ...
    "Fixed-offset tzinfo round-trip" section: onix stores a datetime's UTC
    offset, not its `tzinfo` object. Nothing about the diff itself changes,
    since DeepDiff compares datetimes by instant.
    """
